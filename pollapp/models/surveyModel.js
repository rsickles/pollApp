 ...
 //Callback functions
    ...
    var config = {
        "consumerKey": "OQWwSK7TMur7Hq5YTkRmO5qt0",
        "consumerSecret": "Scbsh86f2ByZIhUVy7aNWGoAB3TA5xOtFnkFJrIklPtIfJrtOh",
        "accessToken": "167251484-QtRyRC7BTByHxdgFXq07svYPxuX2JkgNZNfjFl5w",
        "accessTokenSecret": "62yjzb5j2ieiVZ0Oc96MvzGmXmxPkUqYBRTP3eklZkm9S",
 ...
 */
var connection_string = 'localhost:27017/pollappdb';
/*
...
exports.init = function(io) {
  ...
  io.sockets.on('connection', function (socket) {
    ...
    socket.on('currentDataDistribution', function () {
      // set up later
    });
 ...
 */
 ...
 exports.delete = function(collection, filter, callback) {
  mongoDB
    ...
    .deleteOne(                // Use destroy to only destroy 1 document
      filter,                   // Filter selects which documents to update
